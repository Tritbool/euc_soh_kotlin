  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `detected_wheels` (`macAddress` TEXT NOT NULL, `displayName` TEXT NOT NULL, `userAlias` TEXT, `manufacturer` TEXT, `model` TEXT, `serialNumber` TEXT, `csvFileUris` TEXT NOT NULL, `source` TEXT NOT NULL, `lastScanTimestamp` INTEGER NOT NULL, PRIMARY KEY(`macAddress`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'ee972b79b701477580fb5e78feb36aba')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsDetectedWheels = new HashMap<String, TableInfo.Column>(9);
        ...
        _columnsDetectedWheels.put("userAlias", new TableInfo.Column("userAlias", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "ee972b79b701477580fb5e78feb36aba", "eb52954467664961ec626a2274da40a3");
