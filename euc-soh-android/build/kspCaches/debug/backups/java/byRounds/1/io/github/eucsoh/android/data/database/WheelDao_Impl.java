  ...
  public WheelDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfWheelEntity = new EntityInsertionAdapter<WheelEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `detected_wheels` (`macAddress`,`displayName`,`manufacturer`,`model`,`serialNumber`,`csvFileUris`,`source`,`lastScanTimestamp`) VALUES (?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(6, entity.getCsvFileUris());
        statement.bindString(7, entity.getSource());
        statement.bindLong(8, entity.getLastScanTimestamp());
      }
    };
      ...
      public List<WheelEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new WheelEntity(_tmpMacAddress,_tmpDisplayName,_tmpManufacturer,_tmpModel,_tmpSerialNumber,_tmpCsvFileUris,_tmpSource,_tmpLastScanTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public WheelEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpLastScanTimestamp;
            _tmpLastScanTimestamp = _cursor.getLong(_cursorIndexOfLastScanTimestamp);
            _result = new WheelEntity(_tmpMacAddress,_tmpDisplayName,_tmpManufacturer,_tmpModel,_tmpSerialNumber,_tmpCsvFileUris,_tmpSource,_tmpLastScanTimestamp);
          } else {
            _result = null;
          }
          return _result;
